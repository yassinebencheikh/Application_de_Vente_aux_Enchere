...
public class vendeurcont2 extends Application{
	...
	public void StartContainer() {
		...
		try {
			...
			AgentController agentController=agentContainer.createNewAgent
					("vendeur2", "sma.agents.VendeurAgent2", new Object[] {this});
	...
	public void start(Stage primaryStage) throws Exception {
		...
		StartContainer();
		primaryStage.setTitle("Vendeur2");
	...
	public VendeurAgent2 getVendeur2() {
		return vendeur2;
	}
	public void setVendeur2(VendeurAgent2 vendeur2) {
