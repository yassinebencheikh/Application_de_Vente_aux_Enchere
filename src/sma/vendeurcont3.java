...
import sma.agents.VendeurAgent2;
import sma.agents.VendeurAgent3;


public class vendeurcont3 extends Application{
 
	//liste des string  element de viewliste
	private ObservableList<String> observableList;
	//objet de type agent  pour le container
	private VendeurAgent3 vendeur3;
	
	
	public static void main(String[] args) {
	
		//demmare l'interface graphique du consommateur
		launch(vendeurcont3.class);
	...
	public void StartContainer() {
		...
		try {
			...
			AgentController agentController=agentContainer.createNewAgent
					("vendeur3", "sma.agents.VendeurAgent3", new Object[] {this});
	...
	public void start(Stage primaryStage) throws Exception {
		...
		StartContainer();
		primaryStage.setTitle("Vendeur3");
	...
	public VendeurAgent3 getVendeur3() {
		return vendeur3;
	}
	public void setVendeur3(VendeurAgent3 vendeur3) {
